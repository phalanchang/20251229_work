...
const TodoDetail = ({ todo, onClose, onUpdate }) => {
    ...
    <div style={styles.overlay}>
      <div style={styles.dialog}>
        ...
        <div style={styles.header}>
          <h3 style={styles.headerTitle}>編集</h3>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.metaInfo}>
            <div style={styles.metaItem}>
              <span style={styles.metaLabel}>登録日:</span>
              <span style={styles.metaValue}>{formatDateTime(todo.registeredDate)}</span>
            </div>
            <div style={styles.metaItem}>
              <span style={styles.metaLabel}>更新日:</span>
              <span style={styles.metaValue}>{formatDateTime(todo.updatedDate)}</span>
            </div>
          </div>
